...
namespace NetAdvantageProofs.Data
{
    #region Contexts
    ...
    /// </summary>
    public partial class AdventureWorks : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new AdventureWorks object using the connection string found in the 'AdventureWorks' section of the application configuration file.
        /// </summary>
        public AdventureWorks() : base("name=AdventureWorks", "AdventureWorks")
        {
        ...
        /// <summary>
        /// Initialize a new AdventureWorks object.
        /// </summary>
        public AdventureWorks(string connectionString) : base(connectionString, "AdventureWorks")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new AdventureWorks object.
        /// </summary>
        public AdventureWorks(EntityConnection connection) : base(connection, "AdventureWorks")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="AdventureWorksProducts", Name="Product")]
    [Serializable()]
